...
public class RegistroHuesped extends JFrame {
	...
	private ReservasController reservasConroller;
	int xMouse, yMouse;
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(int id_reserva) {
		
		this.huespedesController = new HuespedesController();
		this.reservasConroller =  new ReservasController();
		...
		String id = String.valueOf(id_reserva);
	...
	private void guardarHuespedes() {
		if(txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {
			 ...
			 this.huespedesController.guardarHuesped(huespedes);
			 
			 Exito exito = new Exito();
			 exito.setVisible(true);
			 dispose();
		}else {
			JOptionPane.showMessageDialog(this, "Por favor diligenciar los campos");
		}
	}
